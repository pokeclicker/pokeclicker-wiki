There are a number of Farming Setups not related to [Breeding Pokemon faster](#!Hatchery/ "Hatchery") or  [Increasing Shiny Chance](https://pokeclicker.miraheze.org/wiki/Shiny_Chance "Shiny Chance")  that are quite useful, particularly when either mutating berries or trying to harvest mutated berries faster, or, even without mutating berries, if you just want to harvest a lot of berries to trade to the  [Berry Master](https://pokeclicker.miraheze.org/wiki/Berry_Master "Berry Master").
